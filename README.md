...
Install Kaygez with one command:

```bash
bash <(curl -Ls https://raw.githubusercontent.com/Kayjz/Kaygez/main/install.sh)
```

During installation, Kaygez downloads the latest public release package, installs the panel, configures the system service, and walks you through the initial setup.

---

## ✨ What Makes Kaygez Different?

Kaygez is designed for operators who need more control, cleaner subscription delivery, and a more practical workflow for real-world Xray deployments.
...
Kaygez is built on top of the Xray ecosystem and is based on the excellent [3X-UI](https://github.com/MHSanaei/3x-ui/) project by MHSanaei.
...
Kaygez is developed and maintained with a focus on quality, stability, and real-world usability.

If you find this project useful and want to support its continued development, you can make a donation here:

[Donate to Kaygez](https://reymit.ir/kaygez)
