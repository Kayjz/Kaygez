...
| **Limit IP**   | all                   | Max simultaneous source IPs (enforced by the Kaygez custom core).        |
...
- **Limit IP** caps simultaneous source IPs inside the Kaygez custom core, before outbound dispatch. You can view a client's recent IPs and clear them from the client's actions.
