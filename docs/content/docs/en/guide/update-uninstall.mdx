...
| 5     | Legacy Version (Disabled)              | Upstream legacy installation is disabled in Kaygez     |
...
- **Legacy upstream versions:** disabled in Kaygez; use the stable or dev channel instead.
