...
bash <(curl -Ls https://raw.githubusercontent.com/Kayjz/Kaygez/main/install.sh) v3.4.0
```
...
[صفحهٔ releases](https://github.com/Kayjz/Kaygez/releases) دانلود کنید، آن را
...
```bash
XUI_NONINTERACTIVE=1 bash <(curl -Ls https://raw.githubusercontent.com/Kayjz/Kaygez/main/install.sh)
```

دایرکتوری [`deploy/`](https://github.com/Kayjz/Kaygez/tree/main/deploy) در مخزن
