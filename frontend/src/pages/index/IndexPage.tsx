...
export default function IndexPage() {
  ...
  function openTelegram() {
    window.open('https://t.me/KaygezPanel', '_blank', 'noopener,noreferrer');
  }
                ...
                <Row gutter={[isMobile ? 8 : 16, 12]}>
                  ...
                  <Col xs={24} lg={12}>
                    <Card
                      title={
                        <Space>
                          <span className="heimdall-brand-text">KAYGEZ</span>
