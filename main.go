// Package main is the entry point for the Kaygez web panel application.
...
import (
	...
	"github.com/Kayjz/Kaygez/v3/internal/sub"
	"github.com/Kayjz/Kaygez/v3/internal/tunnelmonitor"
	"github.com/Kayjz/Kaygez/v3/internal/util/crypto"
	"github.com/Kayjz/Kaygez/v3/internal/util/sys"
	"github.com/Kayjz/Kaygez/v3/internal/web"
...
// runWebServer initializes and starts the web server for the Kaygez panel.
func runWebServer() {
...
// migrateDb performs database migration operations for the Kaygez panel.
func migrateDb() {
...
// main is the entry point of the Kaygez application.
