...
Kaygez's Windows release is built on GitHub Actions with Go, Node.js,
...
and are **not bundled in Kaygez release archives**. The application build
...
The checksum is retained for provenance only. Kaygez does not redistribute
